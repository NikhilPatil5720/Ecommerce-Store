...
function timeout() {
  ...
  function mouseoverNavigation(ele) {
    ...
    document.querySelector(`#${ele}>a`).style.color = "#ab24b5";
  }
  document
    .getElementById("nav1")
  ...
  function mouseoutNavigation(ele) {
    ...
    document.querySelector(`#${ele}>a`).style.backgroundColor = "#ab24b5";
  ...
  let getUser = async (user, token) => {
    let url = `http://localhost:5000/users?username=${user}`;
